  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-100 dark:from-gray-900 dark:to-gray-800">
      <Head>
        ...
        <meta name="description" content="Generate high-quality prompts for AI image generation" />
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-8">
            ...
            <PromptHistory prompts={promptHistory} onSelectPrompt={setGeneratedPrompt} />
          </div>
        </div>
      </main>
